...
def addr_path_to_geoTable():
	user_addr_path = '/Users/fanjianhua/Documents/Github/quora_Scrapy/data/user/Python-programming-language-1_user_addr'
	content = ''
	try:
